...
<body>
	...
	<div class="container">
		...
		<div class="omb_login">
			...
			<h3 class="omb_authTitle">Professionels</h3>
				...
				<div class="col-xs-12 col-sm-6">
					<form id="formulaire" class="omb_loginForm" action=""
						...
						<input name="action" type="hidden"
							value=<%=ConnexionMembre.CREER_COMPTE_PRO%>> <span
						...
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								placeholder="<%=CreationCompteProText.HINT_PSEUDO%>">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nom"
								placeholder="<%=CreationCompteProText.HINT_SIRET%>" name="siret"
								pattern="[0-9]{<%=CreationCompteProText.TAILLE_SIRET_MAX%>}"
								maxlength="<%=CreationCompteProText.TAILLE_SIRET_MAX%>" required>
						</div>
