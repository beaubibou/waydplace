...
public class ProposerNewText {
	...
	public final static String TITRE_PANEL = "Proposez une New";
	public final static String TITRE_ONGLET = "News";
	...
	public static String initNbrCaracteres() {
		...
		return "0 / " + ProposerNewText.TAILLE_DESCRIPTION_NEWS_MAX;
