...
public class ModifierActiviteMembre {
	...
	public static String TITRE_JUMBO = "MOdifier votre activité";
	...
	public static String TITRE_PANEL = "Modifiez une activité";
	public static String TITRE_ONGLET = "Modifiez une activité";
	...
	public static String initNbrCaracteres() {
		...
		return "0 / "
				+ ModifierActiviteMembre.TAILLE_DESCRIPTION_ACTIVITE_MAX;
